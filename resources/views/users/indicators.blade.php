...
<script>
var data = [45,33,80,100]

var svg = d3.select('#result1').append('svg').attr('width',500).attr('height',500)
...
var width = 300;
								...
								var data = [
										{value: 60, label: "Revisión", color: '#d094d4'},
										{value: 90, label: "Práctica", color: '#0c821a'},
										{value: 80, label: "Revisión", color: '#d094d4'},
										{value: 78, label: "Teoría", color: '#127adb'}
								];
	
								function render() {
										var svg = d3.select('#result2').append('svg').attr('width', width).attr('height', width);
